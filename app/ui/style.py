...
THEMES: Dict[str, Dict[str, Any]] = {
    ...
    "morandi_dusk": {
        ...
        "accent": "#9BAAB0",
        "accent_light": "#3A4248",
        "accent_subtle": "rgba(155,170,176,0.10)",
        "user_bubble": "#3B4248",
        "user_bubble_border": "#4A535A",
        "bg": "rgba(43,47,51,0.84)",
        "bg_solid": "#2B2F33",
        "surface": "rgba(54,59,64,0.89)",
        "surface_solid": "#363B40",
        "surface_raised": "#41474D",
        "border": "rgba(255,255,255,0.07)",
        "border_solid": "#4A535A",
        "text": "#D6D2CB",
        "text_secondary": "#A6A39C",
        "text_muted": "#7B7973",
        "ai_bubble": "rgba(54,59,64,0.89)",
        "ai_bubble_border": "rgba(255,255,255,0.07)",
        "scrollbar": "rgba(255,255,255,0.10)",
        "scrollbar_hover": "rgba(255,255,255,0.20)",
        "selected": "rgba(255,255,255,0.06)",
    ...
    "tokyo_night": {
        ...
        "user_bubble": "#283457",
        "user_bubble_border": "#3D59A1",
        "bg": "rgba(26,27,38,0.82)",
        "bg_solid": "#1A1B26",
        "surface": "rgba(36,40,59,0.88)",
        "surface_solid": "#24283B",
        "surface_raised": "#2F344D",
        "border": "rgba(255,255,255,0.07)",
        "border_solid": "#3B4261",
        "text": "#C0CAF5",
        "text_secondary": "#9AA5CE",
        "text_muted": "#565F89",
        "ai_bubble": "rgba(36,40,59,0.88)",
        "ai_bubble_border": "rgba(255,255,255,0.07)",
        "scrollbar": "rgba(255,255,255,0.10)",
        "scrollbar_hover": "rgba(255,255,255,0.20)",
        "selected": "rgba(255,255,255,0.06)",
